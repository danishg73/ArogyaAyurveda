...
public class Byherbs extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_byherbs);
    ...
    public void getdata()
    {
        ...
        list.add(new BasicNameValuePair("category","herb"));
        progressDialog.show();
      uploadToServer readService= new  uploadToServer(new ReadServiceResponse() {
            ...
            public void processFinish(String output)
            {
                ...
                {
                    Toast.makeText(Byherbs.this, getResources().getString(R.string.nodetails), Toast.LENGTH_SHORT).show();
                }
                else
                {
                    insertcat(output);
